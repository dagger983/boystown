  ...
  useEffect(() => {
    const fetchEventData = async () => {
      ...
      try {
        ...
        // Filter for extra-curricular activities
        const extraCurricularActivities = data.filter(event => event.category === 'extra-curricular');
        setEventData(extraCurricularActivities);

        // Extract unique years from the filtered data
        const uniqueYears = [...new Set(extraCurricularActivities.map(event => event.year))];
